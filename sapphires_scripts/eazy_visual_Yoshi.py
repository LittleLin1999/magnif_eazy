...
def show_eazy_result(id, save_dir=None, save_suffix='EAZY', 
    ...
    for i, (filt, img) in enumerate(image_dict.items()):
        ...
        # add SNR
        mag = phot[phot['NUMBER'] == id][f'f_{filt}_aper1'][0]
        err = phot[phot['NUMBER'] == id][f'e_{filt}_aper1'][0]
        snr = mag / err
...
if __name__ == "__main__":
    ...
    eazy_hdf5 ='/home/lxj/data/SAPPHIRE_EAZY/M0416_v0p5/M0416_v0p5_aper1.eazy.h5'
    phot_cat = '/data/sapphires/catalogs/SAPPHIRES_M0416_v0.5.fits'
    img_path = '/data/sapphires/all_mosaics/4750/'
    save_dir = '/home/lxj/data/SAPPHIRE_EAZY/M0416_v0p5/plots/'
    save_suffix = 'M0416_v0p5'
    ...
    for colname in phot.colnames:
        if (colname.endswith(f'_aper1')) and (colname.startswith('f_')): # flux columns 
            filt_tmp = colname.split('_')[1]
