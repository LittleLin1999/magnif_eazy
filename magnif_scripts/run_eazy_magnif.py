...
field_center = {
                # 'M1149': (64.0365916,-24.0707009),
                # 'M0416':(64.0365739,-24.0690009),   
                # 'A2744': (3.5761451, -30.3703087), 
                'A370': (40.008333333333, -1.6),           
               }
field_version = {'A370': 'v2.1', 'A2744': 'v1.0', 'M0416': 'v2.0', 'M1149': 'v1.0'}
"""
We Run Twice using different photometry

# first is the CIRC1
# second is the KRON_S
"""

for field in field_center.keys():

    tmp_version = field_version[field]

    sexcat = Table.read(f'/data_150T/public/MAGNIF/catalog/{field.lower()}_merged_phot_{tmp_version}.ecsv',  format='ascii.ecsv')
    ...
    for suffix in ['CIRC1', 'KRON_S']: 
        ...
        rootname = f'MAGNIF_{field}_{suffix}_{tmp_version}'
        ...
        eazy_catname = f'catalog/{rootname}.eazy.cat'
